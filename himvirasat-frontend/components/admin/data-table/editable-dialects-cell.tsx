            ...
            <PopoverContent className="w-72 p-3 space-y-3" align="start">
                ...
                {isLoadingLookups ? (
                    <div className="h-24 flex items-center justify-center text-xs text-muted-foreground border border-dashed rounded-md bg-muted/20">
                        <Loader2 className="size-4 animate-spin mr-1.5" /> Loading dialects...
                    </div>
                ) : (
                        ...
                        {dbDialects.map((dialect) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center justify-between px-2 py-1 text-[11px] font-medium rounded border transition-all cursor-pointer ${isChecked
