        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-b border-border/40 pb-6">
                ...
                <div className="space-y-1">
                    ...
                    <Select
                        value={editForm.part_of_speech_name || editForm.part_of_speech_id?.toString() || undefined}
                        onValueChange={(val) =>
                            setEditForm((prev) => ({
                                ...prev,
                ...
                <div className="space-y-1">
                    ...
                    <Select
                        value={editForm.dialect_name || editForm.dialect_id?.toString() || undefined}
                        onValueChange={(val) =>
                            setEditForm((prev) => ({
                                ...prev,
                                dialect_name: val,
                ...
                <div className="space-y-1">
                    ...
                    <Select
                        value={editForm.category_name || editForm.category_id?.toString() || undefined}
                        onValueChange={(val) =>
                            setEditForm((prev) => ({
                                ...prev,
                                category_name: val,
            ...
            <div className="space-y-4 border-b border-border/40 pb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-muted/30 dark:bg-muted/10 p-4 rounded-xl border border-border/40">
                    <EditInput
                        ...
                        onChange={(val) => setEditForm((prev) => ({ ...prev, meaning_hindi: val }))}
                    />
                    <EditInput
                        label="English Equivalent"
                        value={editForm.meaning_english}
                        onChange={(val) => setEditForm((prev) => ({ ...prev, meaning_english: val }))}
                    />
                </div>
            </div>
                ...
                <div className="p-4.5 rounded-xl bg-muted/20 border border-border space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <EditInput
                            ...
                            onChange={(val) => setEditForm((prev) => ({ ...prev, example_sentence_latin: val }))}
                        />
                        <EditInput
                            label="Takri Sentence"
                            value={editForm.example_sentence_takri}
                            onChange={(val) => setEditForm((prev) => ({ ...prev, example_sentence_takri: val }))}
                        />
                        <EditInput
                            label="English Sentence"
                            value={editForm.example_sentence_english}
                            onChange={(val) => setEditForm((prev) => ({ ...prev, example_sentence_english: val }))}
                        />
                        <EditInput
                            label="Hindi Sentence"
                            value={editForm.example_sentence_hindi}
                            onChange={(val) => setEditForm((prev) => ({ ...prev, example_sentence_hindi: val }))}
                        />
                    </div>
                </div>
            </div>
